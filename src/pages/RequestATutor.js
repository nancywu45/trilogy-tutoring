    ...
    <div id="requestatutor">
      <div className="requestatutor">
        ...
        <p>
          ...
          rather than to be a substitute. Bring along any questions or if there
          is nothing in particular your child needs help with for that week, we
          will have a lesson plan ready covering content on a similar topic to
